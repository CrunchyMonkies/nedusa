...
ruleTester.run("link-no-cross-module-relationship", rule, {
  valid: [
    ...
    {
      code: `
        import { model as m } from "@nedusa/framework/utils"
    ...
    // Non-framework `model` import — out of scope.
    {
      code: `
        ...
        import Other from "@nedusa/other/models/other"
  ...
  invalid: [
    // belongsTo across modules.
    {
      code: `
        import { model } from "@nedusa/framework/utils"
        import Product from "@nedusa/medusa/product/models/product"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Product",
            source: "@nedusa/medusa/product/models/product",
          },
        },
      ],
    },
    // hasMany across modules.
    {
      code: `
        import { model } from "@nedusa/framework/utils"
        import { Customer } from "@nedusa/customer"
    ...
    // Block body with single return targeting an external import.
    {
      code: `
        import { model } from "@nedusa/framework/utils"
        import Other from "@nedusa/other"
        export default model.define("x", {
    ...
    // Aliased model import.
    {
      code: `
        import { model as m } from "@nedusa/framework/utils"
        import Foreign from "@nedusa/other/models/foreign"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Foreign",
            source: "@nedusa/other/models/foreign",
          },
        },
      ],
    },
