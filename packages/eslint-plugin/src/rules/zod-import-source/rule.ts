...
const BARE_ZOD = "zod"
const MEDUSA_ZOD = "@nedusa/framework/zod"
...
export const rule = createRule<[], MessageIds>({
  ...
  meta: {
    ...
    docs: {
      description:
        "Zod should be imported from `@nedusa/framework/zod` (Medusa v2.13+), not the bare `zod` package.",
    },
    messages: {
      zodImportSource:
        "Import Zod from `@nedusa/framework/zod` instead of `zod`.",
    },
    fixable: "code",
    schema: [],
  },
