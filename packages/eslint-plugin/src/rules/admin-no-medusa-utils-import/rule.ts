...
export const rule = createRule<[], MessageIds>({
  ...
  meta: {
    ...
    docs: {
      description:
        "Don't import Node-only framework modules (`@nedusa/framework/utils`, `@nedusa/framework/http`, `@nedusa/framework/workflows-sdk`) in admin code — they break the browser bundle.",
    },
    messages: {
