...
ruleTester.run("workflow-must-return-workflow-response", rule, {
  valid: [
    ...
    {
      code: `
        import { createWorkflow, WorkflowResponse as WR } from "@nedusa/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, createStep, WorkflowResponse } from "@nedusa/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
  ...
  invalid: [
    ...
    {
      code: `
        import { createWorkflow as cw, WorkflowResponse } from "@nedusa/framework/workflows-sdk"
