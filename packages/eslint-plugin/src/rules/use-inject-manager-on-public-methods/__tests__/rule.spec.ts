...
ruleTester.run("use-inject-manager-on-public-methods", rule, {
  valid: [
    ...
    {
      code: `
        import { MedusaService, InjectManager } from "@nedusa/framework/utils"
    ...
    {
      code: `
        import { MedusaService, InjectTransactionManager } from "@nedusa/framework/utils"
        class FooService extends MedusaService({}) {
    ...
    {
      code: `
        import { InjectManager } from "@nedusa/framework/utils"
        class OrderService {
          async list(sharedContext: Context = {}) {}
        }
      `,
    ...
    {
      code: `
        import { MedusaService, InjectManager as IM } from "@nedusa/framework/utils"
        class FooService extends MedusaService({}) {
          @IM()
          async list(sharedContext: Context = {}) {}
        }
  ...
  invalid: [
    ...
    {
      code: `
        import { MedusaService, InjectManager, EmitEvents } from "@nedusa/framework/utils"
        class FooService extends MedusaService({}) {
          @EmitEvents()
          async list(sharedContext: Context = {}) {}
        }
    ...
    {
      code: `
        import { MedusaService, InjectManager, InjectTransactionManager } from "@nedusa/framework/utils"
        class FooService extends MedusaService({}) {
          async list(sharedContext: Context = {}) {}
          protected async list_(sharedContext: Context = {}) {}
        }
