...
ruleTester.run("no-duplicate-step-id-in-workflow", rule, {
  valid: [
    ...
    {
      code: `
        import { createWorkflow, transform, when, parallelize } from "@nedusa/framework/workflows-sdk"
    ...
    {
      code: `
        import { createWorkflow, parallelize } from "@nedusa/framework/workflows-sdk"
        createWorkflow("hello", () => {
          parallelize(
