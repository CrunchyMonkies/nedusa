...
ruleTester.run("ui-route-config-via-define-route-config", rule, {
  valid: [
    ...
    {
      code: `import { defineRouteConfig } from "@nedusa/admin-sdk"
...
export default CustomPage`,
    ...
    {
      code: `import { defineRouteConfig as drc } from "@nedusa/admin-sdk"
const CustomPage = () => null
...
export default CustomPage`,
    ...
    {
      code: `import { defineRouteConfig } from "@nedusa/admin-sdk"
import type { RouteConfig } from "@nedusa/admin-sdk"
const CustomPage = () => null
