...
ruleTester.run("medusa-context-on-context-param", rule, {
  valid: [
    ...
    {
      code: `
        import { MedusaService, MedusaContext } from "@nedusa/framework/utils"
    ...
    {
      code: `
        import { MedusaService, MedusaContext as MC } from "@nedusa/framework/utils"
        class FooService extends MedusaService({}) {
    ...
    {
      code: `
        import { MedusaContext } from "@nedusa/framework/utils"
        class OrderService {
          async list(sharedContext: Context = {}) {}
        }
      `,
