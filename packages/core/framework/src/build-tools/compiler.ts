import type { AdminOptions, ConfigModule, Logger } from "@nedusa/types"
import { FileSystem, getConfigFile, getResolvedPlugins } from "@nedusa/utils"
...
export class Compiler {
   ...
   * using the "@nedusa/admin-bundler" package.
   */
