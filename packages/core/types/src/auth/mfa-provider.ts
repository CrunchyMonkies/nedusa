 ...
 *
 * ```ts
 * import { AuthMfaProvider } from "@nedusa/framework/types"
 * import { Logger, ModulesSdkTypes } from "@nedusa/framework/types"
 *
 ...
 *
 * ```ts
 * import { RecoveryCodeAuthMfaProvider } from "@nedusa/framework/types"
 * import { Logger, ModulesSdkTypes } from "@nedusa/framework/types"
 *
 * type InjectedDependencies = {
 *   logger: Logger
