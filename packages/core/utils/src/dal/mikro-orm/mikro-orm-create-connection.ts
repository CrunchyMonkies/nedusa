import { Filter as MikroORMFilter } from "@nedusa/deps/mikro-orm/core"
import { TSMigrationGenerator } from "@nedusa/deps/mikro-orm/migrations"
import { ModuleServiceInitializeOptions } from "@nedusa/types"
...
export async function mikroOrmCreateConnection(
  ...
  const { MikroORM, defineConfig } = await import(
    "@nedusa/deps/mikro-orm/postgresql"
  )
