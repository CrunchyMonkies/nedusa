 ...
 * - "policy-bindings.d.ts" - Module augmentation for @nedusa/framework/utils
 *
...
// Module augmentation for @nedusa/framework/utils
// Types and globals are defined in policy-types.d.ts
declare module "@nedusa/framework/utils" {
